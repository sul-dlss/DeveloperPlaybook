...
- qa: deploy to qa with script ... it is also acceptable to run infrastructure-integration-tests after deploy to qa as well or instead of in stage, it is generally not necessary to run in both qa and stage
